    ...
    <div class="card">
        <div class="card-header bg-warning text-dark">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1">
                        <i class="cil-clock me-2"></i>Edit Shift
                    </h5>
                    <p class="mb-0 opacity-75">Update shift information</p>
                </div>
            ...
            <form action="{{ route('shifts.update', $shift) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name', $shift->name) }}" placeholder="e.g., Morning Shift, Night Shift, Weekend Shift" required>
                    @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="duration_hours" id="duration_hours" class="form-control @error('duration_hours') is-invalid @enderror"
                                   value="{{ old('duration_hours', $shift->duration_hours) }}" min="1" max="24" placeholder="8" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                              rows="3" placeholder="Describe this shift schedule and any special conditions">{{ old('description', $shift->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="cil-save me-1"></i> Update Shift
                    </button>
                </div>
            </form>
        </div>
