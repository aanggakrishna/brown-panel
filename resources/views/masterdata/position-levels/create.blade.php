    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1">
                        <i class="cil-layers me-2"></i>Create Position Level
                    </h5>
                    <p class="mb-0 opacity-75">Add a new position level to the system</p>
                </div>
                <a href="{{ route('position-levels.index') }}" class="btn btn-light btn-sm">
        ...
        <div class="card-body">
            <form action="{{ route('position-levels.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name') }}" placeholder="e.g., Junior, Senior, Manager" required>
                            @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="level_order" id="level_order" class="form-control @error('level_order') is-invalid @enderror"
                                   value="{{ old('level_order', 1) }}" min="1" placeholder="1" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                              rows="3" placeholder="Describe this position level and its responsibilities">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="cil-save me-1"></i> Create Position Level
                    </button>
                </div>
            </form>
        </div>
