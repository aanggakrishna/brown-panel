    ...
    <div class="card">
        <div class="card-header bg-warning text-dark">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1">
                        <i class="cil-bank me-2"></i>Edit Bank
                    </h5>
                    <p class="mb-0 opacity-75">Update bank information</p>
                </div>
            ...
            <form action="{{ route('banks.update', $bank) }}" method="POST">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name', $bank->name) }}" placeholder="e.g., Bank Central Asia" required>
                            @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror"
                                   value="{{ old('code', $bank->code) }}" placeholder="e.g., BCA" maxlength="10">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                              rows="3" placeholder="Additional information about this bank">{{ old('description', $bank->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input type="checkbox" name="is_active" id="is_active" class="form-check-input"
                               value="1" {{ old('is_active', $bank->is_active) ? 'checked' : '' }}>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="cil-save me-1"></i> Update Bank
                    </button>
                </div>
            </form>
        </div>
