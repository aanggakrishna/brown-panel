        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function ($row) {
                    $viewBtn = '<a href="' . route('job-titles.show', $row->id) . '" class="btn btn-info btn-sm" data-bs-toggle="tooltip" title="View">👁️</a>';
                    $editBtn = '<a href="' . route('job-titles.edit', $row->id) . '" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="Edit">✏️</a>';
                    $deleteBtn = '<form action="' . route('job-titles.destroy', $row->id) . '" method="POST" style="display:inline;">
